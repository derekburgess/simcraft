...
RING_GRAVITY_CONSTANT = 1 #Default: 1
RING_COLOR = (0, 0, 255) #Default: (0, 0, 255) -- Blue
RING_OPACITY = 50 #Default: 50, Range: 0-255
WOBBLE_MAGNITUDE = 5 #Default: 5
...
NEUTRON_STAR_CHANCE = 0.8  #Default: 0.5
...
NEUTRON_STAR_EFFECT_RADIUS = 50000  #Default: 50000
